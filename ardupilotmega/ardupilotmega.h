...
#define MAVLINK_ARDUPILOTMEGA_XML_HASH -5767213149710481862
...
#include "./mavlink_msg_uavcan_engine_status_ten.h"
#include "./mavlink_msg_uavcan_engine_status_hun.h"
#include "./mavlink_msg_toggle_switches.h"
